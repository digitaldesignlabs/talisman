...
// function parseForBlocks(test) {
//     test.expect(1);
//
//     const contentArray = template.test.parseForTags(testTemplateString, template.test.blockRegex, []);
//     testTemplateFragment += contentArray[0];
//     test.ok(Array.isArray(contentArray), "Result is an array");
//     test.done();
// }
//
// function parseForVariables(test) {
//     test.expect(1);
//
//     const contentArray = template.test.parseForTags(testTemplateFragment, template.test.tagRegex, []);
//     test.ok(Array.isArray(contentArray), "Result is an array");
//     test.done();
// }
//
...
function createValidTemplate(test) {
    // Establish that the correct methods are exposed within the context of the template
    const expectedContextMethods = ["load", "error", "set", "escapeTags", "remove", "restore", "addMask", "render"];
...
function testPage(test) {
    ...
    testTemplate.escapeTags("escapedBlock");
