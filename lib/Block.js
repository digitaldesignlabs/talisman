...
class Block {
    ...
    constructor(content, options) {
        ...
        if (!this.masks.escape) {
            this.masks.escape = require("escape-html");
        }
     ...
     *
     * @param {Map|object|Promise<Map|object>} vars - key-value pairs to store
     * @return {undefined}
     */
    setVariables(vars) {
     ...
     *
     * @param {Array|ReadableStream|Promise<Array|ReadableStream>} raw - An array, an object stream, or Promise for the same
     * @return {undefined}
     */
    setDataSource(raw) {
